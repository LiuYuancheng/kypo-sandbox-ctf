# Cybersecurity game "Junior ctf training"
...
***Note:*** On the transaction machine (kali), the *Open console (deprecated)* and *Open console* connection options do not work anymore. Only the preferred options (*Open GUI* and *SSH access* with external client) work.
